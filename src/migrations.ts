import {ScheduledCronJob, ScheduledJob, TriggerContext, TriggerEventType, WikiPage} from "@devvit/public-api";
...
export async function migrateRules(_: TriggerEventType["AppUpgrade"], context: TriggerContext) {
